...
class EvaluationFormService {
  ...
  static Future<String> enviarAvaliacao({
    ...
    required int teoriaPratica,
    required bool trancouTurma,
    required String porqueTrancou,
    required bool acreditaPassar,
    required String pontoQueAfligiu,
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        'avaliacao': {
          ...
          'passagem_conteudo': passagemConteudo,
          ...
          'teoria_pratica': teoriaPratica,
          'trancou_turma': trancouTurma,
          'porque_trancou': porqueTrancou,
          'acredita_passar': acreditaPassar,
          'ponto_que_afligiu': pontoQueAfligiu,
